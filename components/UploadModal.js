...
export default function UploadModal() {
  ...
  return (
    <div>
        {open && (
            <Modal className={`max-w-lg w-[90%] absolute p-6 top-56 left-[50%] 
                translate-x-[-50%] bg-white border-2 rounded-md shadow-md`}
                isOpen={open}
            ...
            <div className='flex flex-col justify-center items-center h-[100%]'>
                ...
                <input type='text' maxLength='150' placeholder='enter caption...'
